...
public class ModuleExtractor {
	...
	public OWLOntology getLocalityModuleForSignatureGroup(Set<OWLEntity> signature){
		...
		return getLocalityModuleForSignatureGroup(signature, "http://krono.ac.uji.es/Links/ontologies/module-" + Calendar.getInstance().getTimeInMillis() + "-" + Math.random()  + ".owl"); //new UID()
